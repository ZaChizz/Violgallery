...
/* @var $searchModel backend\models\CommentProductSearch */
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return \yii\helpers\Html::a('<div class="text-center"><em data-toggle="tooltip"
                            ...
                            (new yii\grid\ActionColumn())->createUrl('comment-product/view', $model, $model['id'], 1), [
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return \yii\helpers\Html::a('<div class="text-center"><em data-toggle="tooltip"
                            ...
                            (new yii\grid\ActionColumn())->createUrl('comment-product/update', $model, $model['id'], 1), [
                                'title' => Yii::t('yii', 'view'),
                                'data-method' => 'post',
                                'data-pjax' => '0',
                            ]);
                ...
                'buttons' => [
                    'delete' => function ($url, $model) {
                        return \yii\helpers\Html::a('<div class="text-center"><em data-toggle="tooltip"
                            ...
                            (new yii\grid\ActionColumn())->createUrl('comment-product/delete', $model, $model['id'], 1), [
                                'title' => Yii::t('yii', 'view'),
                                'data-method' => 'post',
                                'data-pjax' => '0',
                            ]);
